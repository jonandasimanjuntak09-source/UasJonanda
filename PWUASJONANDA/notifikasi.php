...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $msg = '<div class="alert alert-success">✅ Pengaturan notifikasi berhasil disimpan!</div>';
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .form-check { padding-left:30px; margin-bottom:10px; }
        .form-check-input { width:18px; height:18px; margin-left:-30px; margin-top:2px; accent-color:#5b7cff; }
        .form-check-label { font-size:14px; color:#374151; }
        .form-check .sub { display:block; font-size:12px; color:#888; font-weight:400; }
...
<div class="main-content">
    <div class="page-header">
        <h1><i class="bi bi-bell"></i> Notifikasi <small>Kelola pengaturan notifikasi</small></h1>
    </div>
    <div class="settings-grid">
        <div class="settings-sidebar">
            ...
            <a href="notifikasi.php" class="menu-item active"><i class="bi bi-bell"></i> Notifikasi</a>
        ...
        <div class="settings-card">
            <div class="card-header"><h5><i class="bi bi-bell"></i> Notifikasi</h5></div>
            <div class="card-body">
                <?php echo $msg; ?>
                <form method="POST">
                    <div class="form-group">
                        <div class="form-check"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Notifikasi Event Baru<span class="sub">Diberitahu saat ada event baru</span></label></div>
                        <div class="form-check"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Notifikasi Pendaftaran<span class="sub">Diberitahu saat ada pendaftaran baru</span></label></div>
                        <div class="form-check"><input class="form-check-input" type="checkbox"><label class="form-check-label">Notifikasi Email<span class="sub">Terima notifikasi melalui email</span></label></div>
                        <div class="form-check"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Notifikasi Sistem<span class="sub">Diberitahu tentang update sistem</span></label></div>
                    </div>
                    <button type="submit" class="btn-save"><i class="bi bi-save"></i> Simpan Pengaturan</button>
                </form>
            </div>
        </div>
    </div>
