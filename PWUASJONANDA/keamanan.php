...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($new === $confirm) {
        ...
        $msg = '<div class="alert alert-danger">❌ Password baru tidak cocok!</div>';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .settings-card .card-header h5 i { color:#5b7cff; margin-right:8px; }
        ...
        .form-control { border-radius:10px; border:1px solid #dbe2ea; padding:10px 14px; font-size:14px; width:100%; }
        .form-control:focus { border-color:#5b7cff; box-shadow:0 0 0 3px rgba(91,124,255,0.12); }
...
<div class="main-content">
    <div class="page-header">
        <h1><i class="bi bi-shield-lock"></i> Keamanan Akun <small>Kelola keamanan akun Anda</small></h1>
    </div>
    <div class="settings-grid">
        <div class="settings-sidebar">
            ...
            <a href="keamanan.php" class="menu-item active"><i class="bi bi-shield-lock"></i> Keamanan Akun</a>
        ...
        <div class="settings-card">
            <div class="card-header"><h5><i class="bi bi-shield-lock"></i> Keamanan Akun</h5></div>
            <div class="card-body">
                <?php echo $msg; ?>
                <form method="POST">
                    <div class="form-group"><label><i class="bi bi-lock"></i> Password Lama</label><input type="password" name="old_password" class="form-control" placeholder="Masukkan password lama" required></div>
                    <div class="form-group"><label><i class="bi bi-key"></i> Password Baru</label><input type="password" name="new_password" class="form-control" placeholder="Masukkan password baru" required></div>
                    <div class="form-group"><label><i class="bi bi-check-circle"></i> Konfirmasi Password</label><input type="password" name="confirm_password" class="form-control" placeholder="Konfirmasi password baru" required></div>
                    <button type="submit" class="btn-save"><i class="bi bi-save"></i> Ubah Password</button>
                </form>
            </div>
        </div>
    </div>
